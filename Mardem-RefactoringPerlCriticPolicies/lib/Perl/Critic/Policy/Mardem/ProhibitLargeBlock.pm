...
Perhaps a little code snippet.
    ...
    use Perl::Critic::Policy::Mardem::ProhibitLargeBlock;

    my $foo = Perl::Critic::Policy::Mardem::ProhibitLargeBlock->new();
    ...
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Perl::Critic::Policy::Mardem::ProhibitLargeBlock
